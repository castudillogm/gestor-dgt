...
// Utilizamos la API de Open Data de Euskadi (Tráfico) que provee un JSON público y estructurado
// en tiempo real como alternativa a las limitaciones del NAP de la DGT para este entorno.

export async function obtenerIncidenciasReales() {
  try {
    console.log('🤖 Robot: Buscando incidencias reales en fuentes Open Data...');
    
    // Obtenemos los datos en tiempo real de la API de Tráfico (País Vasco como proxy nacional)
